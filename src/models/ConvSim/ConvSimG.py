...
def buildModel( hyperparameters):
    ...
    return build_convsim_model(HYPER.IMG_HEIGHT, HYPER.IMG_WIDTH, HYPER.OPTIMIZER, HYPER.LOSS)
...
def build_convsim_model( img_height, img_width, optimizer, loss_function  ):

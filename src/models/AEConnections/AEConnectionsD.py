...
def buildModel( hyperparameters):
    ...
    return build_aeconn_model(HYPER.IMG_HEIGHT, HYPER.IMG_WIDTH, HYPER.OPTIMIZER)
...
def build_aeconn_model( img_height, img_width, optimizer ):
    ...
    model_1.compile(optimizer=optimizer, loss='mean_squared_error',metrics=['mean_squared_error'])

...
def calcPredictionMetricsEnsembleWithModel( models, model_ensemble, noisy_images, nitid_images, accuracy_threshold, save_pred = False, save_path = "", noisy_files ="", nitid_files = "", max_nitid = 0 ):
    ...
    weights = model_ensemble.predict(noisy_images)
    ...
    for i in range(images_count):
        ...
        for j in range(4):
            ensemble += predictions[j]*weights[i][j]
